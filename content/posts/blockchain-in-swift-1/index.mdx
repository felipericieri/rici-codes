...
The big majority of us know the term "blockchain" because of Bitcoin. But that isn't its first appearance in the world. David Chaum, a cryptographer, proposed a blockchain-like protocol in his 1982 dissertation "_Computer Systems Established, Maintained, and Trusted by Mutually Suspicious Groups_". 
...
Truth be told, the way Satoshi adopted it to design the first **peer-to-peer cash system** is revolutionary. The ledger, which in a centralised architecture is usually controlled by a single authority, is maintained by a network of nodes instead, open to everyone and owned by nobody. [Here's a video](https://www.youtube.com/watch?v=SzAuB2FG79A) from BBC UK with a good explanation of how it works.
